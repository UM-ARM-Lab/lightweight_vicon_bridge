...
#include "lightweight_vicon_bridge/msg/detail/mocap_marker__rosidl_typesupport_fastrtps_c.h"
...
using _MocapMarker__ros_msg_type = lightweight_vicon_bridge__msg__MocapMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MocapMarker__ros_msg_type * ros_message = static_cast<const _MocapMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: index
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MocapMarker__ros_msg_type * ros_message = static_cast<_MocapMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: index
  {
    cdr >> ros_message->index;
  }
...
static uint32_t _MocapMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lightweight_vicon_bridge__msg__MocapMarker(
...
static size_t _MocapMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lightweight_vicon_bridge__msg__MocapMarker(
...
static message_type_support_callbacks_t __callbacks_MocapMarker = {
...
static rosidl_message_type_support_t _MocapMarker__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MocapMarker,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lightweight_vicon_bridge, msg, MocapMarker)() {
  return &_MocapMarker__type_support;
}
