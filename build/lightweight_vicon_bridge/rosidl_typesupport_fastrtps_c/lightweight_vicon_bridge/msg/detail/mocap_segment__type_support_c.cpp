...
#include "lightweight_vicon_bridge/msg/detail/mocap_segment__rosidl_typesupport_fastrtps_c.h"
...
using _MocapSegment__ros_msg_type = lightweight_vicon_bridge__msg__MocapSegment;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MocapSegment__ros_msg_type * ros_message = static_cast<const _MocapSegment__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MocapSegment__ros_msg_type * ros_message = static_cast<_MocapSegment__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _MocapSegment__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lightweight_vicon_bridge__msg__MocapSegment(
...
static size_t _MocapSegment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lightweight_vicon_bridge__msg__MocapSegment(
...
static message_type_support_callbacks_t __callbacks_MocapSegment = {
...
static rosidl_message_type_support_t _MocapSegment__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MocapSegment,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lightweight_vicon_bridge, msg, MocapSegment)() {
  return &_MocapSegment__type_support;
}
