...
static const _MocapState_type_support_symbol_names_t _MocapState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lightweight_vicon_bridge, msg, MocapState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lightweight_vicon_bridge, msg, MocapState)),
  }
};
...
{
  return &::lightweight_vicon_bridge::msg::rosidl_typesupport_cpp::MocapState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lightweight_vicon_bridge, msg, MocapState)() {
  return get_message_type_support_handle<lightweight_vicon_bridge::msg::MocapState>();
}
